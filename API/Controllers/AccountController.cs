...
namespace API.Controllers
{
    public class AccountController : BaseAPIController
    {
        ...
        public async Task<ActionResult<UserDto>> GetCurrentUser()
        {
            ...
            // Convenience method
            var user = await _userManager.FindByEmailFromClaimsPrinicipal(HttpContext.User);
        ...
        public async Task<ActionResult<AddressDto>> GetUserAddress()
        {
            ...
            // <<<Convenience method from 175...>>>
            var user = await _userManager.FindUserByClaimsPrinicipalWithAddressAsync(HttpContext.User);
